        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="max-w-2xl">
            ...
            <Link 
              ...
              className="inline-block w-full max-w-md px-8 py-4 bg-indigo-600 text-white text-base font-medium rounded-xl hover:bg-indigo-700 transition-colors text-center"
            >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6 text-sm text-neutral-500">
              ...
              <Link href="/contact" className="hover:text-neutral-900 transition-colors">문의하기</Link>
